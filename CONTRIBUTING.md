# Contributing to bottle-time-processor
...
The main way to get help is by sending an email to [envoys-radius3t@icloud.com][support-email].
...
need to be the best programmer to contribute.
 ...
 6. **Build** the project
    - For a detailed look on how to build bottle-time-processor look at our
