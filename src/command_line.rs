...
#[derive(Parser)]
#[clap(version, about = "Processor to read events from MQTT and identify bottle-time events")]
pub struct Options {
    ...
    #[arg(long, env = "MQTT_PASSWORD", default_value = "password", hide_env_values = true)]
    pub password: String,
